...
$image = $_POST["image"];
$date = $_POST["date"];
$req= "insert into contactzied value (null,'$name','$lesson','$image','$date')";
...
<form action="Admin.php" method="POST" enctype="multipart/form-data">
         <input type="text" name="name" id="" placeholder="Name secson" require>
         <input type="text" name="lesson" id="" placeholder="lesson" require>
